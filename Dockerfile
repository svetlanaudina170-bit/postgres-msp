...
# VERSION: 1.0.1
# Path: Dockerfile
# Изменения: добавлен только этот версионный заголовок, содержимое
# сборки не менялось. (Dockerfile и Dockerfile-en идентичны по
# содержимому — по вашему решению это не трогаем.)
# =========================================================================
